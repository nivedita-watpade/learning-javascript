...
if (markData.calcBMI() > johnData.calcBMI()) {
  console.log(
    `${markData.fullName} ${markData.bmi} is higher than ${johnData.fullName} ${johnData.bmi}`
  );
} else {
  console.log(
    `${johnData.fullName} ${johnData.bmi} is higher than ${markData.fullName} ${markData.bmi}`
  );
}
