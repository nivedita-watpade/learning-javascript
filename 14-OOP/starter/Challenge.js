...
const BMWSpeed = new Car('BMW', 110);
BMWSpeed.accelerate();

const mercedesSpeed = new Car('Mercedes', 100);
mercedesSpeed.brake();

new Car('Creta', 120).brake();
...
const electricCar = new EV('Tesla', 100, 24);
